...
export const CARD_LIBRARY = [
  ...
  resident('harlot', 'Распутная девка', null, 63, 1, 'При входе сбрасывает любую женщину в этом городе.', -1, 'whore'),
  ...
  resident('baby', 'Младенец', null, 0, 3, 'При входе сбрасывает Леди или Девку; первым умирает от болезни.'),
